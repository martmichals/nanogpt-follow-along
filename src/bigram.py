...
# Load weights and biases parameters
load_dotenv()
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        required=False,
        help='Sweep ID for W&B sweep'
    )
    parser.add_argument(
        '--sweep_count',
        type=int,
        required=False,
        help='Number of sweep runs to attempt'
    )
    ...
    # Sweep 
    if args.sweep_id is not None and args.sweep_count is not None:
        wandb.agent(
            args.sweep_id, 
            function=main, 
